...
class ProjectController extends Controller
{
    ...
    public function getProject(Request $request, $slug)
    {
        $project = Project::with([
            'tasks.task_members.members',
            'tasks.documents.member',
            'tasks.documents.user',
            'tasks.attachments.member',
    ...
    public function index(Request $request)
    {
        ...
        return response(['data' => $projects->paginate(30)], 200);
    }
    ...
    public function getProjectTasks(Request $request, $projectId)
    {
        ...
        $tasks = Task::with(['task_members.members', 'attachments.member', 'documents.member'])
