...
class TaskController extends Controller
{
    public function createTask(Request $request){
        return DB::transaction(function() use ($request){
            ...
            if (isset($fields['document']) && is_array($fields['document'])) {
                $doc = $fields['document'];
    ...
    public function uploadTaskDocument(Request $request, $taskId)
    {
        try {
            ...
            $request->validate([
                'file' => 'nullable|file|max:10240|mimes:pdf,doc,docx,xls,xlsx,txt,jpg,jpeg,png,gif,svg',
    ...
    // Add this method to support mobile temp file upload before task creation
    public function tempUpload(Request $request)
    {
        try {
            ...
            Log::error('Temp file upload error: ' . $e->getMessage());
